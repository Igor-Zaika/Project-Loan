...
/* harmony import */ var _modules_slider_difference__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/difference */ "./src/js/modules/slider/difference.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  new _modules_slider_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
});
...
/***/ "./src/js/modules/slider/difference.js":
/*!*********************************************!*\
  !*** ./src/js/modules/slider/difference.js ***!
  \*********************************************/
/*! exports provided: default */
  ...
  _createClass(MiniSlider, [{
    ...
    value: function init() {
      ...
      if (this.autoplay) {
        ...
        this.next.addEventListener('mousleave', function () {
          _this4.autoplayGo();
        });
        this.prev.addEventListener('mousleave', function () {
          _this4.autoplayGo();
        });
      }
    }
